...
;; In the comments you will encounter the symbol <??> this means I couldn't decipher the text
;; from the lecture.
;; Harun
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;; 3. The value of the expression (QOUTE FOO) is FOO -- the second element of
;; the expression.
...
;; There are two kinds of procedures: primitives and LAMBDA-created.
...
;;       (* 5 8))
;;
;; The X is (* X Y) is a "free reference." but the X in (LAMBDA (X) (+ X Y))
...
;;
;; The actual argument value is FOO, but we want the result of the substitution to be
;;
;;      (first 'foo)
;;
;; and not
